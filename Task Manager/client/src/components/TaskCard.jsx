...
import { TASK_TYPE, PRIORITYSTYLES, BGS, formatDate } from '../utils';
  ...
  return (<>
    <div className='w-full h-fit bg-white shadow-md p-4 rounded'>
      ...
      <div className='w-full pb-2'>
        <button disabled={user.isAdmin ? false : true} className='w-full flex gap-4 text-gray-500 text-sm font-semibold disabled:cursor-not-allowed disabled:text-gray-300'>
